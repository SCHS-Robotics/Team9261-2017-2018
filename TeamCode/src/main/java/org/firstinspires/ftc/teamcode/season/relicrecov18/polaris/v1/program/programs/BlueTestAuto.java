 ...
 */
@Autonomous(name = "MSPain", group = "Autonomous")
public class BlueTestAuto extends PolarisAutonomousProgram implements CameraBridgeViewBase.CvCameraViewListener2 {
...
//TRY SWITCHING THE BALL AND THE PICTURE TO HAVE IT SEE IT DRIVING OFF
    ...
    public void main() throws InterruptedException {
        ...
        if(latestKey == "left"){
            ...
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.4, 45, 1);
            drive.driveMaintainYaw(5, 0.4, 45, 1);
            ...
            drive.turnExact(0.2, -45, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.4, 135, 1);
            drive.driveMaintainYaw(5, 0.4, 135, 1);
            flippyBoii.stopDispense();
            drive.turnExact(0.2, -90, 1);
        }
        ...
        if(latestKey == "left"){
            ...
            drive.turnExact(0.2, 135, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.8, 135, 1);
            drive.driveMaintainYaw(5, 0.8, 135, 1);
            drive.driveMaintainYaw(5, -0.8, 135, 1);
            drive.driveMaintainYaw(5, 0.8, 135, 1);
            flippyBoii.stopDispense();
            ...
            drive.turnExact(0.2, 45, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.8, 45, 1);
            drive.driveMaintainYaw(5, 0.8, 45, 1);
            drive.driveMaintainYaw(5, -0.8, 45, 1);
            drive.driveMaintainYaw(5, 0.8, 45, 1);
            flippyBoii.stopDispense();
