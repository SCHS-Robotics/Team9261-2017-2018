...
public class CompetitionBlueCenter extends PolarisAutonomousProgram implements CameraBridgeViewBase.CvCameraViewListener2 {
    private String direction;
    //TRY SWITCHING THE BALL AND THE PICTURE TO HAVE IT SEE IT DRIVING OFF
    Mat templateImage;
    ...
    public void main() throws InterruptedException {
        ...
        sleep(3000);
        String latestKey = key;
        telemetry.addData("key, ", key);
        telemetry.update();
        stopOpenCV();
        drive.turnExact(0.15, 0, 1);
        drive.driveMaintainYaw(25, -0.8, 0, 1);
        intake.spitintake();
        sleep(500);
        intake.stopIntake();
        if(latestKey == "left"){
            drive.turnPID(0.2, 70, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.8, 70, 1);
            drive.driveMaintainYaw(5, 0.8, 70, 1);
            drive.driveMaintainYaw(5, -0.8, 70, 1);
            drive.driveMaintainYaw(5, 0.8, 70, 1);
            ...
            drive.turnPID(0.2, 110, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.8, 110, 1);
            drive.driveMaintainYaw(5, 0.8, 110, 1);
            drive.driveMaintainYaw(5, -0.8, 110, 1);
            drive.driveMaintainYaw(5, 0.8, 110, 1);
            flippyBoii.stopDispense();
        ...
        intake.spitintake();
        drive.driveMaintainYaw(24, 0.8, 90, 1);
        drive.turnPID(0.2, 100, 1);
        drive.turnPID(0.2, 90, 1);
        ...
        sleep(1000);
        intake.stopIntake();
        drive.driveMaintainYaw(35, -0.8, 90, 1);
        if(latestKey == "left"){
            drive.turnPID(0.2, 90, 1);
            flippyBoii.dispense();
            ...
            drive.turnPID(0.2, 110, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.4, 110, 1);
            drive.driveMaintainYaw(5, 0.4, 110, 1);
            flippyBoii.stopDispense();
            drive.turnPID(0.2, 90, 1);
        }
            ...
            drive.turnPID(0.2, 70, 1);
            flippyBoii.dispense();
            drive.driveMaintainYaw(5, -0.4, 70, 1);
            drive.driveMaintainYaw(5, 0.4, 70, 1);
            flippyBoii.stopDispense();
            drive.turnPID(0.2, 90, 1);
        }
