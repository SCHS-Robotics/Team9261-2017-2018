...
/**
 * Created by andre_000 on 01/04/2018.
 */
@Autonomous(name = "CryptoDetector", group = "autonomous")
public class CryptoDetector extends LinearOpMode implements CameraBridgeViewBase.CvCameraViewListener2{
